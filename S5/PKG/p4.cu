...
using namespace std;
//														dziala			dziala
#define  N   	4096*4094*3//2048*2046*3//4096*4094*3//1024*1022*3//4096*4094*3	//1048574*3//1048576
#define  BLOCK_SIZE	1024 //64min 1024max
...
int main(void)
{
	...
	unsigned char* cos = readBMP("obrazek3.bmp");
